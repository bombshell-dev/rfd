/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config workers/spacedust.wrangler.jsonc --path workers/worker-configuration.d.ts` (hash: 7982545f5051f73c66082afafa58db4d)
// Runtime types generated with workerd@1.20260507.1 2026-05-10 global_fetch_strictly_public
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./spacedust");
		durableNamespaces: "SpacedustSubscriber";
	}
	interface Env {
		db: D1Database;
		SUBSCRIBER: DurableObjectNamespace<import("./spacedust").SpacedustSubscriber>;
	}
}
